...
export default function Calculation({navigation}) {
  ...
  const calculationY = () => {
    ...
    Y3 = (kadarAlirTrafik3 !=0 && kapasitiLane3 != 0) ? kadarAlirTrafik3 / kapasitiLane3 : 0;
    Y4 = (kadarAlirTrafik4 !=0 && kapasitiLane4 != 0) ? kadarAlirTrafik4 / kapasitiLane4 : 0;
  ...
  const calculationMasaMerah = () => {
    ...
    masaMerahLaluan3 = masaHijauLaluan3 != 0 ? Number(jumlahKitaranMasa) - (Number(masaHijauLaluan3) + Number(masaKuning)) : 0;
    masaMerahLaluan4 = masaHijauLaluan4 != 0 ? Number(jumlahKitaranMasa) - (Number(masaHijauLaluan4) + Number(masaKuning)) : 0;
  ...
  return (
      <SafeAreaProvider style={{flex:1,}}>
        ...
        <View style={{height: DEVICE_HEIGHT * 0.6, paddingVertical: DEVICE_HEIGHT*0.02, paddingHorizontal: DEVICE_WIDTH*0.05 }}>
          {/* ALL field */}
          <Text style={{fontSize:DEVICE_HEIGHT * 0.02, fontWeight:'bold'}}>Sila lengkapkan maklumat di bawah:</Text>

          <View style={{ alignItems:'center', gap:15, marginTop:20}}>
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Jumlah Kehilangan Masa(s)</Text>
              <TextInput style={styles.input} placeholder="12" keyboardType="numeric" value={jumlahKehilanganMasa} onChangeText={(val) => setJumlahKehilanganMasa(val)}/>
            </View>

            <View style={styles.inputContainer}>
              <Text style={styles.label}>Jumlah Kitaran Masa(s)</Text>
              <TextInput style={styles.input} placeholder="90" keyboardType="numeric" value={jumlahKitaranMasa} onChangeText={(val) => setJumlahKitaranMasa(val)}/>
            </View>

            <View style={styles.inputContainer}>
              <Text style={styles.label}>Masa Kuning(s)</Text>
              <TextInput style={styles.input} placeholder="5" keyboardType="numeric" value={masaKuning} onChangeText={(val) => setMasaKuning(val)}/>
            </View>

            <View style={[styles.inputContainer, {flexDirection:'row'}]}>
              <View style={[styles.inputContainer2]}>
                <Text style={[styles.label, {paddingLeft:5}]}>Kadar Alir Trafik</Text>
                <View style={{gap:10, paddingHorizontal:5}}>
                  <TextInput style={styles.input} placeholder="Laluan 1" keyboardType="numeric" value={kadarAlirTrafik1} onChangeText={(val) => setKadarAlirTrafik1(val)}/>
                  <TextInput style={styles.input} placeholder="Laluan 2" keyboardType="numeric" value={kadarAlirTrafik2} onChangeText={(val) => setKadarAlirTrafik2(val)}/>
                  <TextInput style={styles.input} placeholder="Laluan 3" keyboardType="numeric" value={kadarAlirTrafik3} onChangeText={(val) => setKadarAlirTrafik3(val)}/>
                  <TextInput style={styles.input} placeholder="Laluan 4" keyboardType="numeric" value={kadarAlirTrafik4} onChangeText={(val) => setKadarAlirTrafik4(val)}/>
                </View>
              </View>

              <View style={styles.inputContainer2}>
                <Text style={[styles.label, {paddingLeft:5}]}>Kapasiti Laluan</Text>
                <View style={{gap:10,  paddingHorizontal:5}}>
                  <TextInput style={styles.input} placeholder="Laluan 1" keyboardType="numeric" value={kapasitiLane1} onChangeText={(val) => setKapasitiLane1(val)}/>
                  <TextInput style={styles.input} placeholder="Laluan 2" keyboardType="numeric" value={kapasitiLane2} onChangeText={(val) => setKapasitiLane2(val)}/>
                  <TextInput style={styles.input} placeholder="Laluan 3" keyboardType="numeric" value={kapasitiLane3} onChangeText={(val) => setKapasitiLane3(val)}/>
                  <TextInput style={styles.input} placeholder="Laluan 4" keyboardType="numeric" value={kapasitiLane4} onChangeText={(val) => setKapasitiLane4(val)}/>
                </View>
              </View>
        ...
        <View style={{width:DEVICE_WIDTH, position:'absolute', bottom:DEVICE_HEIGHT*0.05, left:0}}>
          <TouchableOpacity 
            ...
            style={{justifyContent:'center', alignItems:'center',  backgroundColor:'#d2cfd2',  paddingVertical:15, marginHorizontal:DEVICE_WIDTH*0.05, borderRadius: 250, elevation:3}}
          >
            <View  style={[styles.shadow]}>
                <Text  style={{fontSize: DEVICE_HEIGHT*0.02, fontWeight:600}}>Kira</Text>
            </View>
          </TouchableOpacity>
         </View>
      </SafeAreaProvider>
